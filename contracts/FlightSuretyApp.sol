...
contract FlightSuretyApp {
    ...
    uint private constant payableValue = 1.5 ether;
     ...
     *
     */
    constructor (address addressDataContract) public
    {
        contractOwner = msg.sender;
        flightSuretyData = FlightSuretyData(addressDataContract);
    }
    ...
    function getAirline(address airlineAddress)
                external view requireIsOperational
                  returns(string name, bool registered, uint256 hasFund, uint256 voteCount)
    {
    ...
    {
        require(msg.value > 0, 'value need to be larger than 0');
        require(msg.value <= 1000000000000000000, 'value need to be less than 1 ether');
